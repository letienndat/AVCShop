    ...
    <div class="container-signup">
        <div class="container-sub-1">
            <ul class="breadcrumb">
                ...
                <li><a href="/AVCShop/src/sign_up.php">Đăng ký</a></li>
            </ul>
        </div>
        ...
        <div class="container-sub-2">
            <div class="content">
                ...
                <p>Nếu bạn đã đăng ký tài khoản, vui lòng đăng nhập <a href="/AVCShop/src/sign_in.php" class="link-login">Tại đây</a></p>
